                ...
                <div className="row ml-lg-4">
                    ...
                    <div className="col-md-6">
                        ...
                        <div className="bg-image-4 ml-lg-4 pt-1 pb-2 mr-lg-4">
                            <div className="row">
                                <div className="pt-2 pl-4 col-md-2 col-2">
                                    <img src="./dashboard/notes_icon.png" />
                                </div>
                                <div className="col-md-6 col-6 pl-lg-3 pl-4">
                                    <h2 className="notes_about_the_week pt-3 mt-1">notes aboutthe week</h2>
                                </div>
                                <div className="col-md-4 text-lg-right col-4 pr-lg-4 pt-3 mt-1">
                                    <span className="pr-1 timestamp">Timestamp</span>
                                    <img src="./dashboard/Group1.png" className="w-25" />
                                </div>
                            </div>
                            <div className="clear-fix"></div>
                        </div>
                        <div className="bg-color-4 ml-lg-4 mr-lg-4">
